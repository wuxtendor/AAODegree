...
from .models import (UGMajor, Grade, User, StudentInfo, SectionInfo, CourseInfo, Section,
                     PassStatus, Course, SubjectChoiceInfo, CreditOption)
...
disclaimer = "The Degree Requirements Progress platform is a comprehensive tool designed exclusively for practice, empowering students to effortlessly track and manage their progress towards degree completion. The student assumes sole responsibility for their degree audit, and in the event of any queries, they may seek assistance from the department of their major."
...
def audit(request, _id):
    ...
    credit_options = CreditOption.objects.all()
    try:
    ...
    return render(request, "../templates/audit.html", context={"major": major, "grades": grades, "id_": _id,
                                                               ...
                                                               "logo": logo, "back": back,
                                                               "credit_options": credit_options, "disclaimer": disclaimer})
