...
class SubjectCode(models.Model):
    ...
    class Meta:
        verbose_name = "Subject abbr"
        verbose_name_plural = "Subject abbrs"
...
class Course(models.Model):
    is_free = models.BooleanField(null=False, default=False)
    course_number = models.IntegerField(null=False, default=1)
    passing_grade = models.ForeignKey(Grade, on_delete=models.CASCADE)
...
class SubjectChoice(models.Model):
    ...
    subject_code = models.ForeignKey(SubjectCode, on_delete=models.CASCADE)
